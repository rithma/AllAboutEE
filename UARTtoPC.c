/*  main.c      from the UART to PC  project.     
this initial edit has the Tiva board ask the user to enter a string, then prints it back.  
later version  to change RGB led depending on input. 
*/
